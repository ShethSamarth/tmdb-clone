...
import {useAddRating} from '../api/movies/use-add-rating';
import {useDeleteRating} from '../api/movies/use-delete-rating';
...
const MovieRating = inject('AuthStore')(
  observer(({AuthStore}: {AuthStore?: AuthStoreType}) => {
    const {params} = useRoute<RouteProp<ParamList, 'MovieRating'>>();
